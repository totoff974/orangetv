...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#commandinfo" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> {{Informations}}</a></li>
    ...
    <form class="form-horizontal">
        <fieldset>
            <div class="form-group">
                <label class="col-sm-3 control-label">{{Nom du décodeur}}</label>
                <div class="col-sm-3">
                    <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                    <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom du décodeur}}"/>
                </div>
            </div>
            <div class="form-group">
...
?>
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label">{{Adresse IP du Décodeur}}</label>
        <div class="col-sm-3">
...
<table id="table_cmd" class="table table-bordered table-condensed">
    <thead>
        <tr>
            <th width="15%">{{Nom de la Commande}}</th><th>{{Code Touche}}</th><th width="20%">{{Action}}</th>
        </tr>
    </thead>
    <tbody>
    </tbody>
...
<div role="tabpanel" class="tab-pane" id="commandinfo">
<table id="table_info" class="table table-bordered table-condensed">
    <thead>
        <tr>
            <th width="15%">{{Nom de l'information}}</th><th>{{Retour}}</th><th width="20%">{{Action}}</th>
        </tr>
    </thead>
    <tbody>
    </tbody>
...
<table id="table_mos" class="table table-bordered table-condensed">
    <thead>
        <tr>
            <th width="15%">{{Nom de la Mosaïque}}</th><th>{{Chaîne Mosaïque}}</th><th width="20%">{{Action}}</th>
        </tr>
    </thead>
    <tbody>
    </tbody>
...
<?php include_file('desktop', 'orangetv', 'js', 'orangetv');?>
